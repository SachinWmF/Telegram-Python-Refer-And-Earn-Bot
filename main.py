...
BOT_TOKEN = "5975031134:AAFAvDd5hBKAtHML3bJIjmDeb3LzAFWRPHk"
PAYMENT_CHANNEL = "@PayoutGallery" #add payment channel here including the '@' sign
OWNER_ID = 1700275419 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@WmfBio"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
              #you can add as many channels here and also add the '@' sign before channel username
Daily_bonus = 50 #Put daily bonus amount here!
Mini_Withdraw = 2600 #remove 0 and add the minimum withdraw u want to set
